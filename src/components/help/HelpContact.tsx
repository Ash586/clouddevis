...
export function HelpContact({ lang }: Props) {
  ...
  return (
    <div className="bg-white border border-[#E4E0D8] rounded-xl p-6 text-center" id="contact">
      <div className="w-10 h-10 rounded-full mx-auto mb-3 flex items-center justify-center text-[18px]" style={{ background: '#1E40AF10' }}>
        💬
      </div>
      <h3 className="text-[14px] font-bold text-[#161616] mb-1">{t('contactTitle')}</h3>
