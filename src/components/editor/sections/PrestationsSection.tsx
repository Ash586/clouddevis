        ...
        <div className="bg-[var(--navy-3)] p-2 rounded-xl border space-y-1.5">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-1.5">
              <button onClick={() => { const v = validateLineItem(newItem); if (!v.valid) { setItemErrors(Object.values(v.errors)[0] ?? null); return; } setItemErrors(null); handleAddItem(); }}
              ...
              <button onClick={() => { setAddingItem(false); setItemErrors(null); }}
        ...
        <div key={item.id} draggable
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-0.5 shrink-0 ml-1">
              ...
              <button onClick={() => idx < doc.items.length - 1 && moveItem(idx, idx + 1)} disabled={idx === doc.items.length - 1}
          ...
          <div className="grid grid-cols-5 gap-1.5 text-[10px] text-[var(--sand-muted)]">
            ...
            <span>{te('prestations.unitLabel')} <strong>{tu(`unit.${item.unit}`) || item.unit}</strong></span>
