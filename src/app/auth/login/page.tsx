    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-[var(--navy)]" style={lightVars}>
      <div className="w-full max-w-[380px] bg-[var(--navy-2)] border border-[rgba(245,237,214,0.08)] rounded-xl p-7 sm:p-6">
        ...
        <div className="my-5 text-center relative">
          ...
          <div className="absolute left-0 right-0 top-1/2 border-t border-[rgba(245,237,214,0.06)] z-0" />
        </div>

        <div className="flex flex-col gap-2">
          <a href={`/api/auth/oauth/google${safeRedirect ? `?redirect=${encodeURIComponent(safeRedirect)}` : ''}`}
            className="flex items-center justify-center gap-2 py-2.5 rounded-lg text-[13px] font-semibold border border-[rgba(245,237,214,0.08)] bg-transparent text-[var(--sand)] no-underline hover:bg-[var(--navy-3)] transition min-h-[44px]">
