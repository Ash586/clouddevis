            ...
            <main className="flex-1 max-w-5xl mx-auto w-full px-3 sm:px-4 py-4 sm:py-8">
              ...
              {showCreate && (
                <Card className="p-4 mb-4">
                  <h3 className="text-sm font-bold text-[var(--sand)] mb-3">{t('createNew')}</h3>
              ...
              {loading ? (
                ...
                <div className="text-center py-12">
                  <svg className="w-12 h-12 text-[var(--sand-muted)] mx-auto mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                  <p className="text-sm text-[var(--sand-muted)]">{t('noTeams')}</p>
                </div>
              ) : (
                  ...
                  {teams.map(team => (
                    <Card key={team.id} className="p-4 cursor-pointer hover:shadow-md transition"
                      ...
                      <div className="flex items-start justify-between mb-2">
                        <h3 className="font-bold text-[var(--sand)]">{team.name}</h3>
                        <span className="text-[10px] text-[var(--sand-muted)] bg-[var(--navy-3)] px-2 py-0.5 rounded-full">
