            ...
            <div className="pricing-grid">
              {[
                ...
                <div key={i} className={`price-card animate-on-scroll ${p.featured ? 'featured' : ''}`}>
                  ...
                  <a href={p.href} className={`btn price-cta ${p.ghost ? 'btn-ghost' : 'btn-primary'}`}>{p.cta}</a>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="container">
            <div className="cta-card">
              ...
              <div className="cta-buttons">
                <a href="/auth/register" className="btn btn-primary btn-lg">Créer mon devis maintenant →</a>
              </div>
            ...
            <div className="footer-grid">
              ...
              <div className="footer-col">
                ...
                <ul>
                  <li><a href="#features">Fonctionnalités</a></li>
                  <li><a href="#pricing">Tarifs</a></li>
                  <li><a href="/auth/register">Démo</a></li>
                </ul>
              </div>
              <div className="footer-col">
                <h5>Aide</h5>
                <ul>
                  <li><a href="#faq">FAQ</a></li>
                  <li><a href="/enterprise">Nous contacter</a></li>
                </ul>
              </div>
              <div className="footer-col">
                <h5>Légal</h5>
